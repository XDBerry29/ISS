...
public class BibleotecarSignUpController {
    @FXML
    ...
    public void signInClick(ActionEvent actionEvent) throws IOException  {
        ...
        if (cnp.isEmpty() || email.isEmpty() || telefon.isEmpty() || nume.isEmpty()) {
            errorLabel.setText("All fields must be filled!");
        }else {
            try {
                service.addAbonat(cnp, email, nume, telefon, cnp);
                errorLabel.setText("Inregistrareas-a facut cu succes!");
            } catch (Exception e) {
